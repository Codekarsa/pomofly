...
export function usePomodoro(initialSettings: PomodoroSettings, onComplete?: (completedPhase: PomodoroPhase) => void) {
  ...
  const handlePhaseComplete = useCallback(() => {
    const completedPhase = phase; // Store the phase that just completed

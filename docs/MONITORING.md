...
```jsx
import { useMonitoring, useApiMonitoring, useFormMonitoring } from '@/hooks/useMonitoring';
...
monitoring.recordMetric('task_creation_time', duration, ['performance', 'user_action']);
```

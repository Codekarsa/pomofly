...
const BLUE_PNG_BASE64 =
  'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChAI9jU8D+gAAAABJRU5ErkJggg==';
...
function createPlaceholderIcons() {
  ...
  console.log(
    '⚠️ These are temporary placeholders - replace with actual branded icons'
  );
  console.log('');
